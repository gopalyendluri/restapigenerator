...
namespace Gk\RESTApiGenerator\Command;
...
use Gk\RESTApiGenerator\Generator\DoctrineRESTGenerator;
use Sensio\Bundle\GeneratorBundle\Command\Validators;
use Gk\RESTApiGenerator\Manipulator\RoutingManipulator;
...
class GenerateDoctrineRESTCommand extends GenerateDoctrineCrudCommand
{
    ...
    protected function configure()
    {
        $this->setDefinition(
            ...
            ->setHelp(
                <<<EOT
                The <info>gk:generate:rest</info> command generates a REST api based on a Doctrine entity.

<info>php app/console gk:generate:rest --entity=AcmeBlogBundle:Post --route-prefix=post_admin</info>
...
EOT
            ...
            ->setName('gk:generate:rest')
            ->setAliases(array('generate:gk:rest'));
    }
